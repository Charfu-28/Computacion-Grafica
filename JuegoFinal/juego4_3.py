...
class Estacionario(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if(randint(0,60) < self.rangodisparo):
            bes = BalaEstacionario(ro)
            bes.rect.x = self.rect.x+15
            bes.rect.y = self.rect.y+50
            BalaEstacionario.add(bes)
            general2.add(bes)
#==============================================Jefe Nivel 3=================================================
...
#============================================ObjetoDanino Nivel 2===============================================
    ...
    x=600
    y=634
    Od2 = ObjetoDanino2(Ob2, x, y)
    ObjetoDanio2.add(Od2)
    general2.add(Od2)
...
#============================================================================================================
        if  partJuego.texto_inicia() and not Fin_Juego:
            ...
            general3.update()
            lista_plataformas = pygame.sprite.Group()
            Num_plata = [[600+f_x3,600],[1500+f_x3,500], [2000+f_x3,400],[2400+f_x3,550],[3000+f_x3,500], [3300+f_x3,520]]
            Num_Plataformas(pl, Num_plata)
            sonic.lista_plataformas=lista_plataformas
