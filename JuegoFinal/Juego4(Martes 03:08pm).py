...
#====================================Colision de Sonic Con Bill_Bala=========================================
        for j in vida2:
            ...
            for elem in ls_col10:
                ...
                general2.remove(j)
                ptos2-=1
#========================COLISION DE SONIC CON TODOS LOS PERSONAJES DEL NIVEL 3=============================
        for w in vida3:
            ls_col11 = pygame.sprite.spritecollide(sonic,EneGoomba, True)
            for elem in ls_col11:
                vida3.remove(w)
                general3.remove(w)
                ptos3-=1
            ls_col12 = pygame.sprite.spritecollide(sonic,EneKamek, True)
            for elem in ls_col12:
                vida3.remove(w)
                general3.remove(w)
                ptos3-=1
            ls_col13 = pygame.sprite.spritecollide(sonic,EneBill, True)
            for elem in ls_col13:
                vida3.remove(w)
                general3.remove(w)
                ptos3-=1
...
#============================================================================================================
        if  partJuego.texto_inicia() and not Fin_Juego:
            ...
            pantalla.fill(NEGRO)
            lev1 = pygame.image.load ('FinNivel1.png')
            ...
            general2.update()
            lista_plataformas = pygame.sprite.Group()
            Num_plata = [[110,15,1545+f_x2,550],[200,10,150+f_x2,500], [80,10,2200+f_x2,300],[80,10,1200+f_x2,500], [80,10,1250+f_x2,300]]
            ...
            pantalla.fill(NEGRO)
            lev2 = pygame.image.load ('FinNivel2.png')
