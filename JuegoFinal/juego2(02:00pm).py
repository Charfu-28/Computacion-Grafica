...
#=============================================================================================================
        ...
        if  partJuego.texto_inicia() and not Fin_Juego:
            ...
            if sonic.rect.x>=ANCHO/2+400-sonic.rect.width and f_x+fondo_ancho>ANCHO:
                sonic.rect.x=ANCHO/2+400-sonic.rect.width
                f_x-=4
            ...
            if sonic.rect.x>=ANCHO/2+400-sonic.rect.width and f_x+fondo2_ancho>ANCHO:
                sonic.rect.x=ANCHO/2+400-sonic.rect.width
                f_x-=4
            pantalla.blit(fondo2, [f_x, 0])
            ...
            if var_global == 3:
                pantalla.fill(NEGRO)
                textop = fuente2.render("Instrucciones", True, BLANCO)
                pantalla.blit(textop,[300,340])
                textopp=fuente2.render(str(puntaje), True, BLANCO)
                pantalla.blit(textopp,[500,340])
                pygame.display.flip()
            if var_global == 2:
                pantalla.fill(NEGRO)
                textop = fuente2.render("Creditos", True, BLANCO)
                pantalla.blit(textop,[300,340])
                pygame.display.flip()
            if var_global == 1:
                pantalla.fill(NEGRO)
